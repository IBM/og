...
.CSV Format For Basic and AWS Authentication Example
[source, bash]
----
username1,password1
username2,password2
...
.CSV Format for Keystone Authentication Example
[source, bash]
----
token1
token2
...
=== Write, Overwrite, Read, Metadata, Delete, List, Container Create, Container List, Multipart Write Operations
...
For S3 API, account name and containers list are not required.
