...
If a legalhold prefix is specified, that will be used. Otherwise, the prefix is
LegalHold.
...
generated objects. Filesize configuration block can be added to _write_, _overwrite_ and _multi_write_ 
