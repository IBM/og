...
=== Write, Writecopy, Overwrite, Read, Metadata, Delete, List, Container Create, Container List, Multipart Write Operations
...
can be encrypted by setting sse_c_target property to true.
