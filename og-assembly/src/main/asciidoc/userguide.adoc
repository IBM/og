...
Each line in the new credential file has to be a json representation of the account information. The information depends on the API,
type of authentication used. Multiline json blob is not accepted.
