 ...
 * @since 1.0
 */
public class ConcurrentRequestsCondition extends CounterCondition {

  public ConcurrentRequestsCondition(final Operation operation, final long thresholdValue,
