...
public class ConcurrentRequestsConditionTest {
  @Rule
  ...
  public void invalidConcurrentRequestsCondition(final Operation operation,
    ...
    new ConcurrentRequestsCondition(operation, thresholdValue, test, stats);
  }

  @Test
  public void concurrentRequestsCondition() {
    final ConcurrentRequestsCondition condition =
        new ConcurrentRequestsCondition(Operation.WRITE, 2, this.test, this.stats);
  ...
  public void parentUpdateOverriden() {
    final ConcurrentRequestsCondition condition =
        new ConcurrentRequestsCondition(Operation.WRITE, 1, this.test, this.stats);
