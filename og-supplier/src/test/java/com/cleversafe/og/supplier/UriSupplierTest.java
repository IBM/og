...
public class UriSupplierTest
{
   ...
   {
      final URI uri =
            new UriSupplier.Builder(this.host, this.path).withScheme(Suppliers.of(Scheme.HTTPS)).build().get();
      assertThat(Scheme.valueOf(uri.getScheme().toUpperCase(Locale.US)), is(Scheme.HTTPS));
   }
   ...
   public void path()
   {
      final URI uri = new UriSupplier.Builder(this.host,
            ImmutableList.of(Suppliers.of("container"), Suppliers.of("object"))).build().get();
   ...
   {
      final URI uri =
            new UriSupplier.Builder(this.host, this.path).withTrailingSlash().build().get();
      assertThat(uri.getPath(), is("/container/"));
   }
   ...
   {
      final URI uri =
            new UriSupplier.Builder(this.host, this.path).withQueryParameter("key", "value").build().get();
   ...
   {
      final URI uri = new UriSupplier.Builder(this.host, this.path)
