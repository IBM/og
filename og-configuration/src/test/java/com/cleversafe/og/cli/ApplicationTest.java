...
public class ApplicationTest
{
   ...
   public static Object[][] provideInvalidCli()
   {
      ...
      return new Object[][]{
            {null, jsap, args, NullPointerException.class},
   ...
   public static Object[][] provideInvalidFromJson()
   {
      ...
      return new Object[][]{
            {null, null, Item.class, gson, NullPointerException.class},
   ...
   public void invalidFromJson(
         final File userJson,
         final File defaultJson,
         final Class<?> cls,
         final Gson gson,
