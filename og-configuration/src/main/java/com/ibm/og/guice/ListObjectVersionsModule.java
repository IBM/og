...
import com.ibm.og.guice.annotation.ListObjectVersionsQueryParameters;
...
public class ListObjectVersionsModule extends AbstractModule {
   ...
   */
  public ListObjectVersionsModule(final OGConfig config) {
  ...
  @Provides
  @Singleton
  @ListObjectVersionsQueryParameters
  public Map<String, Function<Map<String, String>, String>> provideListQueryParameters(
          final Api api) {
    final Map<String, Function<Map<String, String>, String>> queryParameters;

    queryParameters = provideQueryParameters(this.config.listObjectVersions.parameters);

    final Map<String, Function<Map<String, String>, String>> weightedQueryParameters =
            provideWeightedQueryParameters(this.config.listObjectVersions.weightedParameters);
  ...
  @Provides
  @Singleton
  @Named("listObjectVersions.context")
  public List<Function<Map<String, String>, String>> provideListObject(
          final ObjectManager objectManager) {
    Function<Map<String, String>, String> function;

    final OperationConfig operationConfig = checkNotNull(this.config.listObjectVersions);
  ...
  @Provides
  @Singleton
  @Named("listObjectVersions.container")
  public Function<Map<String, String>, String> provideListContainer() {
    if (this.config.listObjectVersions.container.prefix != null) {
      return ModuleUtils.provideContainer(this.config.listObjectVersions.container);
    } else {
  ...
  @Provides
  @Singleton
  @Named("listObjectVersions.prefix")
  public Function<Map<String, String>, String> provideListPrefix(final SelectionConfig<PrefixConfig> listPrefixConfig) {
    if (this.config.listObjectVersions.prefix == null) {
      return null;
    }
    final SelectionConfig<PrefixConfig> prefixConfig = this.config.listObjectVersions.prefix;
  ...
  @Provides
  @Singleton
  @Named("listObjectVersions.delimiter")
  public Function<Map<String, String>, String> provideListDelimiter(final SelectionConfig<ListDelimiterConfig> listDelimiters) {
    if (this.config.listObjectVersions.listDelimiter == null) {
      return null;
    }
    final SelectionConfig<ListDelimiterConfig> delimiterConfig = this.config.listObjectVersions.listDelimiter;
  ...
  public Supplier<Request> provideList(
          ...
          @ListObjectVersionsQueryParameters final Map<String, Function<Map<String, String>, String>> queryParameters,
          @Named("listObjectVersions.container") final Function<Map<String, String>, String> container,
          @Nullable @Named("api.version") final String apiVersion,
          @ListHeaders final Map<String, Function<Map<String, String>, String>> headers,
          @Named("listObjectVersions.context") final List<Function<Map<String, String>, String>> context,
          @Nullable @Named("listObjectVersionsSession.Supplier") final Function<Map<String, String>, ListSessionConfig> listTypeSupplier,
          @Nullable @Named("listObjectVersions.prefix") final Function<Map<String, String>, String> prefixSupplier,
          @Nullable @Named("listObjectVersions.delimiter") final Function<Map<String, String>, String> delimiterSupplier,
    ...
    return createListRequestSupplier(api, this.config.listObjectVersions, Operation.LIST_OBJECT_VERSIONS, id,
            Method.GET, scheme, host, port, uriRoot,
  ...
  private Supplier<Request> createListRequestSupplier(final Api api, final OperationConfig config, final Operation operation,
    ...
    return new ListOperationsSupplier(api, config, operation, id, method, scheme, host, port, uriRoot, container,
            apiVersion, object, queryParameters, false, headers, context, listSessionConfigSupplier,
            prefixSupplier, delimiterSupplier, credentials, virtualHost, objectManager);
  }
