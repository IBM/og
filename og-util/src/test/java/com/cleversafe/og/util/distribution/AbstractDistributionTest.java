...
public abstract class AbstractDistributionTest {
  ...
  public static Object[][] provideInvalidDistribution() {
    ...
    return new Object[][] { {-1.0, 0.0, random, IllegalArgumentException.class},
  ...
  public void invalidDistribution(final double average, final double spread, final Random random,
  ...
  public static Object[][] provideDistribution() {
    return new Object[][] { {0.0, 0.0}, {10.0, 0.0}, {10.0, 2.0},};
  }
