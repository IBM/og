...
public interface ResponseBodyConsumer {
   ...
   * @return a metadata iterator containing elements that were processed based on the content of the
   *         response body, or an empty iterator if no metadata was generated
